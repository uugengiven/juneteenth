      ...
      <div className="flex flex-wrap justify-between">
        <div className="w-full md:w-1/2 p-4 bg-yellow-100 rounded-l-lg text-center">
          ...
          <ul className="flex flex-wrap justify-center mt-6 sm:mt-10">
            <li className="flex flex-col items-center mb-6 w-full sm:w-1/2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 640 512"
                className="relative max-w-20 sm:max-w-24"
              >
              ...
              <span className="text-3xl text-center mt-1">$669K</span>
            </li>
            <li className="flex flex-col items-center mb-6 w-full sm:w-1/2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="text-3xl text-center mt-1">$290K</span>
            </li>
            <li className="flex flex-col items-center mb-6 w-full sm:w-1/2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="text-3xl text-center mt-1">$1.66M</span>
            </li>
            <li className="flex flex-col items-center mb-6 w-full sm:w-1/2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="-96 0 640 512"
                className="relative max-w-20 sm:max-w-24"
              >
                <path d="M160 112c0-35.3 28.7-64 64-64s64 28.7 64 64v48H160V112zm-48 48H48c-26.5 0-48 21.5-48 48V416c0 53 43 96 96 96H352c53 0 96-43 96-96V208c0-26.5-21.5-48-48-48H336V112C336 50.1 285.9 0 224 0S112 50.1 112 112v48zm24 48a24 24 0 1 1 0 48 24 24 0 1 1 0-48zm152 24a24 24 0 1 1 48 0 24 24 0 1 1 -48 0z" />
              </svg>
              <span className="text-3xl text-center mt-1">$406K</span>
            </li>
            <li className="flex flex-col items-center mb-6 w-full sm:w-1/2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="text-3xl text-center mt-1">$174K</span>
            </li>
          </ul>
        </div>
