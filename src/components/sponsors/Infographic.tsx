const Infographic:React.FC = () => {
    return (
        ...
        <div className="w-1/2 p-4 rounded-lg">
            <h2 className="text-3xl font-bold mb-2 px-4">Homecoming Celebration 2023</h2>
            <h2 className="text-4xl font-bold bg-orange-500 text-white p-4 rounded-bl-2xl rounded-tr-2xl">Event Dates: June 14-16</h2>
        </div>
        <div className="w-1/2 p-4 text-center">
            <span className="text-5xl font-bold text-green-500">$3.49 Million</span>
            <p className="text-xl">in direct resident and visitor spending for Allegheny County</p>
        </div>
        </div>

        {/* Second section */}
        <div className="bg-green-100 rounded-lg p-6">
        <h3 className="text-4xl font-bold mb-4">Estimated total attendance: 48.8K</h3>
        ...
        <div className="w-1/2 p-4 bg-yellow-100 rounded-l-lg text-center">
            <h3 className="text-4xl font-bold mb-4 text-blue-700">Major Spend by Category</h3>
            <ul className="flex flex-wrap justify-center">
              <li className="flex flex-col items-center mb-4 w-1/2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="relative max-w-28">
          ...
          <div className="w-1/2 p-4 bg-purple-100 rounded-e-lg">
            <h3 className="text-3xl font-bold mb-4 text-center">Out of Town Visitors</h3>
            ...
            <div className="bg-white rounded-lg p-6">
                <h4 className="text-xl font-bold mb-2">Top Visitor Origin Markets</h4>
