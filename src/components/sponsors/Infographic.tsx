    ...
    <div className="flex flex-col space-y-8">
      ...
      <div className="flex flex-wrap justify-between">
        <div className="w-full md:w-1/2 p-4 bg-yellow-100 rounded-l-lg text-center">
          ...
          <ul className="flex flex-wrap justify-center mt-6 sm:mt-8">
            <li className="flex flex-col items-center mb-4 w-full sm:w-1/2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 640 512"
                className="relative max-w-16 sm:max-w-20"
              >
